...
export default class Conhecer extends React.Component {
	// const completarpet = () => {
	// 	navigation.navigate('CompletarPet')
	// }
	criarPets = async () => {
		...
		return (
			<View style={styles.container}>
				<ScrollView>
					...
					<Text style={styles.texto}>Data e região onde se perdeu</Text>
					...
					<MapView
						...
						<View style={{ top: '50%', left: '50%' }}>
							<Image
								...
								source={{
									uri: 'file:///data/user/0/host.exp.exponent/cache/ExperienceData/UNVERIFIED-127.0.0.1-DetaPet/ImagePicker/b77d8967-7705-4398-a7fb-091000e19e5b.png',
								}}
							/>
						</View>
					</MapView>
